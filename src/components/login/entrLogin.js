...
import {loginEntrepreneur} from "../../JS/actions/jobsAction"
...
const login=(e,payload)=>{
  e.preventDefault()
  props.loginEntrepreneur(payload)
}

return(
<div className = 'opecity'>
<div className="container-login-entrepreneur">
...
export default connect(mapStateToProps,{loginEntrepreneur,clearErrors})(EntrLogin)